...
int main(int argc, char *argv[]) {
  if (argc == 1) {
// the list below I screw up, please check if you want to use it :/ sorry!
...
/* things below for UL16
    vector<int> IOVlist = {266150, 271866, 272761, 272828, 273158, 273301, 274094, 274954, 274968, 275059, 275635, 276054, 276237, 276315, 276327, 276832, 276952, 277935, 278017, 278271, 279479, 279588, 279681, 279881, 279976, 280187, 280242, 280365, 280928, 281663, 281693, 282649, 282917, 283305, 283681, 284025, 284038};  //UL16
vector<int> pixelupdateruns {271866, 276315,278271, 280928};//UL16
...
/*	DMRtrends(IOVlist,
 	{"median", "DrmsNR"},
  	 {"singlemuon"},
	"2016", 
	"/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/data/commonValidation/results/alelek/DMR_UL16_3-Oct_newAPEsmp3297/", 
	{"EOY2016", "EOY2016newPixelTemplate", "mp3218m", "mp3297m"}, 
	{kRed, kOrange, kCyan+2, kGreen+2}, 
	"/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/data/commonValidation/results/alelek/DMR_UL16_1Oct19_DMRtrends4", 
	true, 
	pixelupdateruns,
 	true, 
	true); */
