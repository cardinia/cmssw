...
goodLumiSecs = LumiList.LumiList(filename = '/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN/MP/MPproduction/datasetfiles/UltraLegacy/2017/brute_force_method_v3/HLTPhysics_Run2017G-TkAlMinBias-17Nov2017-v1_ALCARECO/Golden.json').getCMSSWString().split(',')
