...
readFiles.extend(['/store/data/Run2016C/HLTPhysics/ALCARECO/TkAlMinBias-07Dec2018-v1/80000/8A16DB54-CC09-E911-8E1F-7CD30AD0A5CA.root','/store/data/Run2016C/HLTPhysics/ALCARECO/TkAlMinBias-07Dec2018-v1/80000/327C6D5A-1809-E911-B7E7-001E67E713EF.root','/store/data/Run2016C/HLTPhysics/ALCARECO/TkAlMinBias-07Dec2018-v1/80000/4CD56E5D-F608-E911-9751-001E67DDC119.root','/store/data/Run2016C/HLTPhysics/ALCARECO/TkAlMinBias-07Dec2018-v1/80000/1667DA13-F608-E911-A103-509A4C74D08C.root','/store/data/Run2016C/HLTPhysics/ALCARECO/TkAlMinBias-07Dec2018-v1/80000/92DEBAFD-C908-E911-8FBD-0CC47A4D7630.root'])
...
process.TFileService = cms.Service("TFileService",
                                   fileName=cms.string("PVValidation_EOY2016newPixelTemplates_275782.root")
                                  )                                    
...
if isDA:
     ...
     process.PVValidation = cms.EDAnalyzer("PrimaryVertexValidation",
                                           ...
                                           intLumi = cms.untracked.double(93.812542205),
