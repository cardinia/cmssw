...
readFiles.extend(['/store/data/Run2016H/HLTPhysics/ALCARECO/TkAlMinBias-07Dec2018-v1/20000/3C618359-2912-E911-9347-003048FFCBB8.root'])
...
process.TFileService = cms.Service("TFileService",
                                   fileName=cms.string("PVValidation_EOY2016newPixelTemplates_282035.root")
                                  )                                    
...
if isDA:
     ...
     process.PVValidation = cms.EDAnalyzer("PrimaryVertexValidation",
                                           ...
                                           intLumi = cms.untracked.double(9.499631684),
