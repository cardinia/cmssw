...
readFiles.extend(['/store/data/Run2016D/HLTPhysics/ALCARECO/TkAlMinBias-07Dec2018-v1/20000/18DE4DDB-8C09-E911-87CF-0CC47A7C345E.root','/store/data/Run2016D/HLTPhysics/ALCARECO/TkAlMinBias-07Dec2018-v1/20000/120E7FB4-3B08-E911-B061-0025905A60D2.root'])
...
process.TFileService = cms.Service("TFileService",
                                   fileName=cms.string("PVValidation_EOY2016newPixelTemplates_276495.root")
                                  )                                    
...
if isDA:
     ...
     process.PVValidation = cms.EDAnalyzer("PrimaryVertexValidation",
                                           ...
                                           intLumi = cms.untracked.double(40.084983836),
